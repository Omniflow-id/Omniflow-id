          ...
          <div className="container-enterprise relative z-10">
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-white/10">
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200/70">{t("affiliate.hero.stats.commission")}</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200/70">{t("affiliate.hero.stats.lifetime")}</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200/70">{t("affiliate.hero.stats.businesses")}</div>
              </div>
              <div className="text-center">
                ...
                <div className="text-sm text-blue-200/70">{t("affiliate.hero.stats.payout")}</div>
              </div>
            </div>
          </div>
        </section>
